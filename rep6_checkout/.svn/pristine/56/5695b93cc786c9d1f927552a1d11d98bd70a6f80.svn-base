...
$jboss_config_file = "$ENV{'JBOSS_HOME'}/standalone/configuration/standalone-full-ha.xml";
$jboss_boot_log    = "$ENV{'JBOSS_HOME'}/standalone/log/boot.log";
$atao_custom_props = "$ENV{'JBOSS_HOME'}/standalone/deployments/atao.ear/atao.war/WEB-INF/classes/custom.properties";
...
$username = $ARGV[9];  #user
$password = $ARGV[10];  #pass
...
{
  $maxdir = 0;
  $host = "kws-us-bomvsr1.corp.unicru.com";
  #$directory = "export/data/dev-ftp/azetra/packages/8.7/8.7.8.0/";
